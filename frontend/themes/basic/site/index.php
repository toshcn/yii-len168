...
<div class="wrapper slide-wrapper hidden-sm hidden-xs">
    <div class="slide-post w-center">
        <div class="carousel slide-carousel">
            <div class="slide-list carousel-inner">
                <?php foreach ($topPosts as $key => $top) {
                    $top['author'] = Html::encode($top['author']);
                ?>
                <div class="item <?= ($key == 0) ? 'active' : '';?>" data-item-index="<?= $key + 1; ?>">
                    <div class="item-content">
                        <div class="post-img animated pulse pull-left">
                            <a href="<?= Url::to(['/article/detail', 'id' => $top['postid']], true); ?>" target="_blank">
                                <img class="img-responsive" src="<?= $top['image'] ? $top['image'] . '_500x300' . $top['image_suffix'] : Yii::$app->params['post.header.image']; ?>" width="100%" alt="<?= Html::encode($top['title']) ?>">
                            </a>
                        </div>
                        <div class="post-text animated fadeInDown pull-left">
            ...
            <div class="col-sm-4">
                <div class="post-box post-unview">
                    <div class="post-thumb">
                        ...
                        <img class="img-responsive" src="<?= $post['image'] ? Url::to($post['image'] . '_326x195' . $post['image_suffix'], true) : Yii::$app->params['post.header.image']; ?>" alt="" width="100%">
                    </div>
                    <div class="post-body">
                        <div class="post-content">
                            <h3 class="post-title">

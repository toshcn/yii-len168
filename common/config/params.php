...
return [
    ...
    'username.validate' => ['len168', 'admin', '管理员', '站长', '毛泽东', '毛主席', '共产党', '国民党', '周恩来', '周总理', '江泽民', '胡锦涛', '温家宝', '习近平', '李克强', '张德江', '俞正声', '刘云山', '王岐山', '张高丽', '李鹏', '做爱', '性爱', '手淫', '淫液', '爱液', '精液', '精子', '子宫', 'sex交', '性交', '射精', '幼交', '兽交', '约炮', '操B', '骚女', '骚B', '骚逼', '骚货', '贱B', '贱逼', '操逼', '妈B', '妈逼', '性虐', '肛交', '口交', '色群', 'se群', '群交', '群P', '三P', '多P', '狼友', '全套服务', '莞式服务', '强奸', '猥亵', '轮奸', '诱奸', '迷奸', '鸡巴', '鸡ba', '鸡8', '阴茎', '阴道', '自慰', '睾丸', '生殖器', '一夜情', '换妻', '卖淫', '嫖娼', '鸡奸', '色情', '情趣用品', '成人用品',  '走私', '六合彩', '赌博', '博彩', '香港马会', '毒品', '冰毒', '摇头丸', '海洛因', '大麻', 'K粉', '李洪志', '全能神', '法轮功', '台独', '港独',
    ],
